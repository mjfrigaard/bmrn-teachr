...
This tutorial exposes you to some basic R functions and syntax. 
...
The normal distribution is symmetrical around mean (or average). 

- The tails represent spread (variance) from location (central tendency)

```{r normal-dist.png, echo=FALSE, out.width = "100px"}
knitr::include_graphics(path = "img/normal-dist.png")
```
